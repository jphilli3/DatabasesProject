  ...
  template: `
    ...
    <div class="table-scroll">
      <table class="chord-table">
        <tr>
          <app-song-chord-view [chords]="searchChords"></app-song-chord-view>
        </tr>
      </table>
    </div>
  `
...
export class SearchSongBarComponent  {
  apiURL = 'http://localhost:8000/songs/';
  constructor(private http: HttpClient, private svc: ApiService) { }
  chords: any = [];
  searchChords: any[] = [];
